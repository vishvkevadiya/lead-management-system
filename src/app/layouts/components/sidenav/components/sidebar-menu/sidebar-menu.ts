    ...
    },
    {
      ...
      children: [
        ...
        { type: 'item', label: 'Checkout', link: '/e-commerce/checkout' },
        {
          type: 'item',
          label: 'Add Products',
          link: '/e-commerce/product-create',
        },
        { type: 'item', label: 'Orders', link: '/e-commerce/orders' },
        {
          type: 'item',
          label: 'Order Details',
          link: '/e-commerce/order-overview',
        },
    ...
    },
    {
      ...
      children: [
        ...
        { type: 'item', label: 'Logout', link: '/auth-boxed/logout' },
        {
          ...
          link: '/auth-boxed/reset-password',
        },
        {
          type: 'item',
          label: 'Create Password',
          link: '/auth-boxed/create-password',
        },
      ],
    },
  ];
